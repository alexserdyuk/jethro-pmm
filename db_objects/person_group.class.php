	...
	protected static function _getFields()
	{
		$fields = Array(
			...
			'show_add_family'	=> Array(
									...
									'default' => 'no',
									'label' => _('Show on add-family page?'),
									'note' => _('Should this group be shown as an option when <a href="?view=families__add">adding a new family</a>?'),
									'divider_before' => true,
									),
			'share_member_details' => Array(
									...
									'default' => 'no',
									'note' => _('Should members of this group be able to see each others\'s details in <a href="').BASE_URL._('members">member portal</a>?'),
									'label' => _('Share member details?'),
								),
		);
		...
		if(in_array('ATTENDANCE', $enabled)){
			 $fields['attendance_recording_days']	= Array(
									...
									'default'	=> 0,
									'label'		=> _('Attendance Recording Days'),
									'cols'		=> 4,
									'note'		=> _('If you want to record attendance at this group, select the applicable weekdays. '),
